	...
	*/
	...
	this
		...
		.error(function(e) { 
			...
			var mensajesmp=""+e.data.error;
			//alert(e.data.error[0]+" s "+e.data.error[2]);
			if(e.data.error[0]=="errMkdir" && e.data.error[2]=="errExists"){
							var opts  = {
						...
						if (e.data.opts && $.isPlainObject(e.data.opts)) {
							...
							self.dialog('<span class="elfinder-dialog-icon elfinder-dialog-icon-confirm"/>Carpeta creado correctamente.', opts);
			}else if(e.data.error[0]=="errMkfile" && e.data.error[2]=="errExists"){
													var opts  = {
											cssClass  : 'elfinder-dialog-confirm',
											title     :"Repositorio",
											resizable : false,
									...
									if (e.data.opts && $.isPlainObject(e.data.opts)) {
										...
										self.dialog('<span class="elfinder-dialog-icon elfinder-dialog-icon-confirm"/>Archivo creado correctamente.', opts);
	...
	if (true === this.options.sound) {
		this.bind('playsound', function(e) {
			...
			play && file && play != '' && play != 'no' && $(beeper).html('<source src="http://200.37.200.182/assetsfiles/grocery_crud/elfinder/sounds/rm.wav" type="audio/wav">')[0].play();
