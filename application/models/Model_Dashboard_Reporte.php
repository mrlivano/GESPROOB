...
class Model_Dashboard_Reporte extends CI_Model
{
    ...
    function DetallePedidoCompraMeta($correlativoMeta,$anioMeta,$sec_ejec)
    {
        ...
        else
        {
            ...
            FROM SIGA.dbo.SIG_PEDIDOS INNER JOIN
            SIGA.dbo.SIG_PERSONAL ON SIG_PEDIDOS.SEC_EJEC = SIG_PERSONAL.sec_ejec AND SIG_PEDIDOS.EMPLEADO = SIG_PERSONAL.empleado
    ...
    function DetallePorCadaPedido($nropedido,$anio,$tipopedido,$tipobien, $sec_ejec)
    {
        ...
        else
        {
            ...
            FROM SIGA.dbo.SIG_DETALLE_PEDIDOS INNER JOIN
            SIGA.dbo.SIG_CLASIFICADOR_GASTO ON SIG_DETALLE_PEDIDOS.ID_CLASIFICADOR = SIG_CLASIFICADOR_GASTO.ID_CLASIFICADOR AND 
            SIG_DETALLE_PEDIDOS.ANO_EJE = SIG_CLASIFICADOR_GASTO.ANO_EJE
            INNER JOIN SIGA.dbo.catalogo_bien_serv ON SIG_DETALLE_PEDIDOS.GRUPO_BIEN=catalogo_bien_serv.GRUPO_BIEN AND
    ...
    function DetallePorCadaNumOrden($anio,$tipobien,$numorden,$tipoppto, $sec_ejec)
    {
        ...
        else
        {
            ...
            FROM SIGA.dbo.SIG_ORDEN_ITEM INNER JOIN
            SIGA.dbo.CATALOGO_BIEN_SERV ON SIG_ORDEN_ITEM.ITEM_BIEN = CATALOGO_BIEN_SERV.ITEM_BIEN AND 
    ...
    function EspecificacionOrden($anio,$tipobien,$numorden, $sec_ejec)
    {
        ...
        if($sec_ejec=='748')
        {
            ...
            from siga.dbo.SIG_ORDEN_ITEM o inner join siga.dbo.CATALOGO_BIEN_SERV c 
            ...
            inner join siga.dbo.UNIDAD_MEDIDA m on c.UNIDAD_MEDIDA=m.UNIDAD_MEDIDA
