...
function autorizar($url)
{
    ...
    $lista_API = array(
      ...
      'Expediente_Tecnico/clonacionModificatoria',
      ...
      'ET_Periodo_Ejecucion/listarCronogramaEjecucion',
      ...
      'Expediente_Tecnico/reporteFE08',
      'Expediente_Tecnico/reporteFE10',
      'Expediente_Tecnico/reporteFE11',
      ...
      'Expediente_Tecnico/reportePdfExpedienteTecnicoDirecta',
      ...
      'Expediente_Tecnico/insertarResponsableEjecucionJuridica',
      'Expediente_Tecnico/listarResponsableElaboracion',
      'Expediente_Tecnico/listarResponsableEjecucionAD',
      'Expediente_Tecnico/listarResponsableEjecucionAI',
      ...
      'ET_Detalle_Formato/ReporteFE08',
      'ET_Detalle_Formato/ReporteFE10',
      'ET_Detalle_Formato/ReporteFE11',
      ...
      'ET_Componente/cargarSelectComponentePresupuesto',
      ...
      'Expediente_Tecnico/insertDesagregadoGastos',
      'Expediente_Tecnico/insertDesagregadoGastosSupervision',
      'Expediente_Tecnico/insertDesagregadoGastosLiquidacion',
