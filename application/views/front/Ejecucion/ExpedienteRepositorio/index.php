						...
						<table id="tablaRepositorio" class="table table-striped jambo_table bulk_action  table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<td class="col-md-2 col-xs-12">Nombre</td>
									<td class="col-md-5 col-xs-12">Opciones</td>
								</tr>
							</thead>
							<tbody>
							<?php foreach($listaExpediente as $item){ ?>
								<tr>									
									...
									<td style="width:5%;">
										<a class="btn btn-success btn-xs" target="_blank" href="http://sigeiapp.regionapurimac.gob.pe:9090/repositorio.php?carpeta=<?=$item->carpeta?>&proyecto=<?= $item->nombre_proyecto?>">Mostrar Archivos</a>
									</td>									
								</tr>
							<?php } ?>
							</tbody>
