...
<body>
	<div id="header">
  	...
  	<div id="content">
		...
		<div>
			<h2><?=$componente->numeracion?>. <?=html_escape($componente->descripcion)?></h2>
			<?php foreach($componente->childMeta as $index => $item) { ?>
				<?= mostrarAnidado($item)?>
			<?php } ?>
		</div>
	</div>
