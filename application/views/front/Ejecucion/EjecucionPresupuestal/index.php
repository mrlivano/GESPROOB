<div class="right_col" role="main">
	<div class="x_panel">
		<div class="x_title">
			<h2><b>Ejecución Presupuestal</b></h2>
			<div class="clearfix"></div>
		</div>
		<div class="x_content">   
			<form class="form-horizontal" id="frmEjecucionPresupuestal" action="<?php echo base_url();?>index.php/Manifiesto_Gasto/reporteEjecucionPdf" method="POST" target="_blank">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row" id="divEjecucionPresupuestal">
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								...
								<div>       
									<input style="width:100%;" type="button" class="btn btn-default" value="Buscar" onclick="busquedaEjecucion();">
								</div>		
							</div>
							<div class="col-md-2 col-sm-2 col-xs-12">
								<label class="control-label">.</label>
								<div> 
									<input style="width:100%;" type="button" class="btn btn-warning" value="Exportar a PDF" onclick="exportarEjecucionPDF();">
								</div>		
							</div>		
						</div>
					</div>
			...
			<div class="table-responsive">
				<div id="contenedorEjecucionPresupuestal"></div>
			</div>
		</div>
	</div>
</div>
<script>
	...
	{	
        ...
        $.ajax({
            type:"POST",
            url:base_url+"index.php/Manifiesto_Gasto/busquedaEjecucionPresupuestal",
            data: 
			{
            ...
            {
				$('#divModalCargaAjax').hide();
				$('#contenedorEjecucionPresupuestal').html(objectJSON);
			},
			error:function ()
			{
				swal("Error", "Ha ocurrido un error inesperado", "error")
	...
	function exportarEjecucionPDF()
	{
		...
		$('#frmEjecucionPresupuestal').submit();
	}
</script>