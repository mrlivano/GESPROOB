...
<head>
	<title>FORMATO FF-13  Desagregado de Equipos y Herramientas</title>
	<meta charset="utf-8">
</head>
<body style="font-family: Helvetica;text-align: center;">
	...
	<div style="text-align: center;font-size: 13px;font-weight:bold; ">FORMATO FF-13</div>
	<div style="text-align: center;font-size: 15px;font-weight:bold;">DESAGREGADO DE EQUIPOS Y HERRAMIENTAS</div>
				...
				<tbody>
					<?php foreach($value->childInsumo as $key => $item) { ?>
						<tr>
							...
							<td>---</td>
							<td style="text-align: right;"><?=a_number_format($item->cantidad , 2, '.',",",3)?></td>
