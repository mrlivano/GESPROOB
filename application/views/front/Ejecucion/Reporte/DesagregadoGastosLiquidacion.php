...
<html>
<head>
	<title>Desagregado de Gastos de Liquidación</title>
	<style>
	.nivel1
	{
		color:white;
...
<body style="font-family: Helvetica;text-align: center;">
	...
	<div style="text-align: center;font-size: 13px;font-weight:bold; ">FORMATO FF-09B</div>
	<div style="text-align: center;font-size: 15px;font-weight:bold;">DESAGREGADO DE GASTOS DE LIQUIDACIÓN</div>
		...
		<div style="font-size: 9px;">
			<table id="tablaResumen">
				...
				<?php foreach($expedienteTecnico->childCostoIndirecto as $key => $value) {  ?>
					...
					<?php } ?>
					<tr>
						<td colspan="2">TOTAL GASTOS DE LIQUIDACIÓN</td>
