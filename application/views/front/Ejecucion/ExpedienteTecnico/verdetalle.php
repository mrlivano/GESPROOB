	...
	<div>
		...
		<div class="col-md-12 col-xs-12 col-xs-12">
            ...
            <div id="myTabContent" class="tab-content">
              ...
              <li style="width:15%;"  role="presentation" class="">
								<a href="#tabSeguimiento"  id="profile-tab" role="tab" data-toggle="tab" aria-expanded="false"><b> Gestión del Proyecto</b></a>
              </li>
													...
													<ul class="list-unstyled timeline">
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="" onclick="paginaAjaxDialogo(null, 'Registro de componentes, metas y partidas', { idExpedienteTecnico : <?=$ExpedienteTecnicoElaboracion[0]->id_et?> }, base_url+'index.php/ET_Componente/insertar', 'GET', null, null, false, true); return false;">2.- Analítico del Presupuesto General </a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="" onclick="paginaAjaxDialogo(null, 'Registro de Costo Indirecto', { idExpedienteTecnico : <?=$ExpedienteTecnicoElaboracion[0]->id_et?> }, base_url+'index.php/ET_Pie_Presupuesto/insertar', 'GET', null, null, false, true); return false;">3.- Registro de Costo Indirecto. </a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
													...
													<ul class="list-unstyled timeline">
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="" onclick="window.open(base_url+'index.php/ET_Cronograma_Ejecucion/index?id_et=<?=$ExpedienteTecnicoElaboracion[0]->id_et?>', '_blank'); return false;">3.- Cronograma valorizado de ejecución del proyecto</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Expediente_Tecnico/ControlMetrado?id_et='.$ExpedienteTecnicoElaboracion[0]->id_et);?>" target='_blank'>4.- Ejecución Diaria de Metrados.</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Expediente_Tecnico/ValorizacionFisicaMetrado?id_et='.$ExpedienteTecnicoElaboracion[0]->id_et);?>" target='_blank'>5.- Valorización Mensual.</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															 <div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?=site_url('Expediente_Tecnico/InformeMensual?idExpedienteTecnico='.$ExpedienteTecnicoElaboracion[0]->id_et);?>">6.- Informe Mensual.</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Manifiesto_Gasto/insertar?idExpedienteTecnico='.$ExpedienteTecnicoElaboracion[0]->id_et);?>">7.- Manifiesto de Gastos </a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Manifiesto_Gasto/busquedaEjecucionPresupuestal?idExpedienteTecnico='.$ExpedienteTecnicoElaboracion[0]->id_et);?>">8.- Ejecución Presupuestal  </a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Manifiesto_Gasto/programacionClasificador?idExpedienteTecnico='.$ExpedienteTecnicoElaboracion[0]->id_et);?>">9.- Programación de Presupuesto por Clasificador  </a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?=site_url('ET_Maquinaria/index?query='.$ExpedienteTecnicoElaboracion[0]->id_et);?>">10.- Registro de Maquinaria</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
														...
														{ ?>
															<div>
																...
																<a style="background-color: #e73e3a;" href="" onclick="paginaAjaxDialogo(null, 'Formato FE', { idExpedienteTecnico : <?=$ExpedienteTecnicoElaboracion[0]->id_et?> }, base_url+'index.php/Expediente_Tecnico/reporteFER', 'GET', null, null, false, true); return false;" title="FE-R" class="btn btn-app btn-box">
																	<i class="fa fa-file-pdf-o"></i> Formato FE-R
																</a>
												...
												<div style="padding-top:20px;padding-bottom:20px;">
													...
													<li>
														...
														<li>
															<div class="block">
																<div class="tags">
																	<a href="<?= site_url('Expediente_Tecnico/ControlMetradoI?id_et='.$ExpedienteTecnicoElaboracion[0]->id_et);?>" target='_blank'  class="tag">
																	<span>Ejecución Diaria.</span>
																	</a>
																</div>
																<div class="block_content">
																	<h2 class="title">
																	<a href="<?= site_url('Expediente_Tecnico/ControlMetradoI?id_et='.$ExpedienteTecnicoElaboracion[0]->id_et);?>" target='_blank'>2.- Ejecución Diaria de Metrados.</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
