												...
												<div style="padding-top:20px;padding-bottom:20px;">
													<ul class="list-unstyled timeline">
														<li>
															<div class="block">
																<div class="tags">
																	<a href="" onclick="paginaAjaxDialogo(null, 'Asignación de especialistas requeridos', { idExpedienteTecnico : <?=$ExpedienteTecnicoElaboracion[0]->id_et?> }, base_url+'index.php/ET_PER_REQ/insertar', 'GET', null, null, false, true); return false;" class="tag">
																	<span>Personal</span>
																	</a>
																</div>
																<div class="block_content">
																	<h2 class="title">
																	<a href="" onclick="paginaAjaxDialogo(null, 'Asignación de especialistas requeridos', { idExpedienteTecnico : <?=$ExpedienteTecnicoElaboracion[0]->id_et?> }, base_url+'index.php/ET_PER_REQ/insertar', 'GET', null, null, false, true); return false;">1.- Registro del Personal</a>
																	</h2>
																	<div class="byline">
																		<span></span> <a></a>
																	</div>
																	<p class="excerpt">Se debe realizar el registro del personal que interviene en la elaboración del expediente técnico </p>
																</div>
															</div>
														</li>
														<li>
															<div class="block">
																...
																<div class="block_content">
																	<h2 class="title">
																	<a href="" onclick="window.open(base_url+'index.php/ET_Tarea/index?id_et=<?=$ExpedienteTecnicoElaboracion[0]->id_et?>', '_blank'); return false;">2.- Gestión y Asignación de Actividades</a>
																	</h2>
																	<div class="byline">
																		<span></span><a></a>
																	</div>
