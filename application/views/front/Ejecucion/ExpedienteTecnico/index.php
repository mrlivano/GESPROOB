								...
								<div class="table-responsive">
									<table id="table-ExpedienteTecnico" style="text-align: center;" class="table table-striped jambo_table bulk_action  table-hover" cellspacing="0" width="100%">
										...
										<?php foreach($listaBD as $item){ ?>
										  	<tr>
										  		<td style="width: 15%;">
										  			<a style="width: 100%;" href="<?= site_url('Expediente_Tecnico/monitorCoordinador?codigo='.$item->CodigoUnico);?>" role="button" class="btn btn-success btn-sm"><span class="fa fa-eye"></span> <?= $item->CodigoUnico?></a>
