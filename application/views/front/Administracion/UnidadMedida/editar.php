<form class="form-horizontal " id="form-editarUnidad_Medida" action="<?php echo  base_url();?>index.php/Unidad_Medida/editar" method="POST">
	...
	<div class="item form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Abreviatura <span class="required">*</span>
		</label>
		<div class="col-md-6 col-sm-6 col-xs-12">
			<input id="txtAbreviatura" name="txtAbreviatura" value="<?=$unidadMedida->abreviatura;?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2"  placeholder="Abreviatura" autocomplete="off" type="text">
		</div>
	</div>
