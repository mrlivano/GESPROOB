...
<!-- Datatables -->
  ...
  <script src="<?php echo base_url(); ?>assets/vendors/butons/buttons.colVis.min.js"></script>
    ...
    <script src="../assets/js/administrador/Gerencia.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/js/administrador/tipoUsuario.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/administrador/especialidad.js"></script>
  </body>
</html>
