		...
		<div class="main_container">
			...
			<div class="top_nav">
				<div class="nav_menu">
                  ...
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false" onclick="mostrarMensajes();">
                    <i class="fa fa-envelope-o"></i>
                    <span class="badge bg-green" id="hdMensajesPorLeer"><?=$mensajesNoLeidos?></span>
                  </a>
                 	<ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu"  style="height: 250px; overflow-y: scroll;" >
...
<script>
	function mostrarMensajes()
	{
		$.ajax(
        {
            url: base_url+'index.php/Mo_BandejaMonitoreo/ListaMensajes',
            type: 'POST',
            cache: false,
            async: true
        }).done(function(objectJSON)
        {
			...
			{
				html+='<li style="background-color: '+(objectJSON[i].visto==1 ? '#f7f7f7' : '#ddecf1')+'"><a><span class="time">'+objectJSON[i].fecha_registro+'</span></span><span style="text-transform:uppercase; font-size:10px;" class="message"><b style="color:#021914;">'+objectJSON[i].mensaje+'</b> del proyecto '+objectJSON[i].nombre_pi+'</span></a></li>';
			}
			$('#contenedorMensajes').html(html);
            $('#hdMensajesPorLeer').text("0");
	...
	function UpdateBandeja()
	{
		$.ajax(
        {
            url: base_url+'index.php/Mo_BandejaMonitoreo/editarBandeja',
            type: 'POST',
            cache: false,
            async: true
        }).done(function(objectJSON)
