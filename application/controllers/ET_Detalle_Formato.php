	...
	public function ReporteFER()
	{
      ...
      $anio=$metaPresupuestal[1];
			...
			if($reporte=='FE01'){
				...
				$reportePdf='Front/Ejecucion/InformeMensual/reporteFE01'.$reporte;
				$doc="Reporte".$reporte.".pdf";
				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE01', ['proyectoInversion'=>$proyectoInversion,'fuenteFinanciamieto'=>$fuenteFinanciamieto,'montoasignado'=>$montoasignado,'plazoPogramado'=>$plazoPogramado,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE01.pdf", array("Attachment" => false)); 
			...
			foreach ($childComponenteAdicional as $key => $value)
			{
				...
				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE03', ['proyectoInversion'=>$proyectoInversion,'arrayPartidaEjecutada'=>$arrayPartidaEjecutada,'arrayAdicional'=>$arrayAdicional,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE03.pdf", array("Attachment" => false)); 
				...
				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE05', ['proyectoInversion'=>$proyectoInversion,'montoasignado'=>$montoasignado,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'presupuestoProgramado'=>$presupuestoProgramado,'presupuestoAnterior'=>$presupuestoAnterior,'presupuestoActual'=>$presupuestoActual,
				'ejecutadoAnterior'=>$ejecutadoAnterior,'ejecutadoActual'=>$ejecutadoActual,'adicionalProgramado'=>$adicionalProgramado,'adicionalAnterior'=>$adicionalAnterior,'adicionalActual'=>$adicionalActual,'costoIndirectoProgramado'=>$costoIndirectoProgramado,'costoIndirectoAnterior'=>$costoIndirectoAnterior, 'costoIndirectoActual'=>$costoIndirectoActual,'financieroAnterior'=>$financieroAnterior,
				'financieroActual'=>$financieroActual,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE05.pdf", array("Attachment" => false)); 
				...
				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE08', ['proyectoInversion'=>$proyectoInversion,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE08.pdf", array("Attachment" => false)); 

			} elseif ($reporte=='FE10') {
				

				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE10', ['proyectoInversion'=>$proyectoInversion,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE10.pdf", array("Attachment" => false)); 

			} elseif ($reporte=='FE11') {
				
				$html=$this->load->view('Front/Ejecucion/InformeMensual/reporteFE11', ['proyectoInversion'=>$proyectoInversion,'detalleFormato'=>$detalleFormato,'fechaReporte'=>$fechaReporte,'responsableDetalle'=>$responsableDetalle], true);
							$this->mydompdf->load_html($html);
							$this->mydompdf->render();
							$this->mydompdf->stream("ReporteFE11.pdf", array("Attachment" => false)); 
